import { VStack, Button, useColorModeValue, HStack, Icon, Text } from "@chakra-ui/react";
  ...
  return (
    <VStack w="250px" p={4} spacing={4} bg={sidebarBg} borderRight="1px solid" borderColor={sidebarBorder}>
      <VStack spacing={2} align="stretch" w="full">
        ...
        <Button as={NavLink} to="/my-posts" {...itemProps('/my-posts')} w="full">
          <HStack spacing={2}>
            <Icon as={FaFileAlt} boxSize={5} />
            <Text>Bài của tôi</Text>
          </HStack>
        </Button>
      </VStack>
    </VStack>
