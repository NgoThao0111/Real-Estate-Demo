...
const AllListings = () => {
  ...
  const initialType = searchParams.get("rental_type") || ""; // <--- MỚI: Lấy loại tin từ URL

  const [sortBy, setSortBy] = useState(initialSort);
  const [rentalType, setRentalType] = useState(initialType); // <--- MỚI: State quản lý loại tin
  ...
  const handleTypeChange = (newType) => {
    setRentalType(newType); // Cập nhật UI ngay
    ...
    if (newType === "") {
      ...
      delete currentParams.rental_type;
    } else {
      // Nếu chọn Sell/Rent, thêm vào URL
      currentParams.rental_type = newType;
    }
        ...
        <Grid templateColumns={{ base: "1fr", lg: "350px 1fr" }} gap={8}>
          ...
          <GridItem>
            ...
            <SortViewOpts
              ...
              setRentalType={handleTypeChange}

              viewType={viewType}
              setViewType={setViewType}
              countText="dự án phù hợp"
            />
